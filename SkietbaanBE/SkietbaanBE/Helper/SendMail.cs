        ...
        public bool SendPasswordEmail(string To, string Subject, string token)
        {
            try
            {
                using (MailMessage mail = new MailMessage())
                {
                    ...
                    MailAssignment(mail, emailFromAddress, To, Subject, $"<img src='https://firebasestorage.googleapis.com/v0/b/skietbaan-351ab.appspot.com/o/password%20reset.png?alt=media&token=b989fdf4-b19b-4e64-82aa-cf2ba41cc7ef'></img><div><h2 style='text-align: center;margin:auto;margin-right: 150px;margin-top:-120px;'>Click here to reset your password: <a href='{url}{token}'>Reset Password</a></h2><div>");
                    SmtpSend(mail);
                }
            }
            catch (Exception e)
